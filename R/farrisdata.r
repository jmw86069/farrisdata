...
#' bw_strand <- c("pos", "neg");
#' bw_mid <- c("_1.sickle.merged.cutadapt.STAR_mm10.",
#'    "-X.STAR_mm10.");
#' bw_suffix <- ".bw";
#' bw_urls <- paste0(
#'    rep(bw_pre1, each=16),
#'    rep(rep(bw_factor1, each=4), 5),
#'    rep(rep(rep(bw_factor2, each=2), 4), 5),
#'    rep(bw_pre2, each=16),
#'    rep(bw_mid, c(48, 32)),
#'    bw_strand,
#'    bw_suffix
...
#' bw_urls <- gsub("^NS50266.*(CA1|CA3|496|CB).*", NA, bw_urls);
